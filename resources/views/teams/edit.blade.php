        ...
        <form method="POST" action="{{ route('teams.update', $team) }}" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <x-text-input
                    ...
                    class="block w-full mt-1 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                    :value="old('title', $team->title)"></x-text-input>
            ...
            <div class="mb-4">
                ...
                <textarea
                    ...
                    class="block w-full mt-1 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">{{ old('desc', $team->desc) }}</textarea>
            ...
            <div class="mb-4">
                ...
                <div class="avatar my-4 block">
                    <div class="w-16 rounded-xl ring-gray-500 ring-offset-base-100 ring ring-offset-2">
                        <img class="image-preview" src="{{ asset('storage/' . $team->image) }}" />
                    </div>
                </div>
