<x-app-layout>
    ...
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8 bg-white border border-[#FF8F00] mt-4 shadow-md rounded-md">
        <form method="POST" action="{{ route('social-media.update', $social) }}" enctype="multipart/form-data">
            @csrf
            @method('patch')
            ...
            <div class="mb-4">
                ...
                <x-text-input
                    ...
                    :value="old('name', $social->name)"></x-text-input>
            ...
            <div class="mb-4">
                ...
                <x-text-input
                    ...
                    :value="old('url', $social->url)"></x-text-input>
            ...
            <div class="mb-4">
                ...
                <x-text-input
                    ...
                    class="block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                    :value="old('username', $social->username)"></x-text-input>
                <x-input-error :messages="$errors->get('username')" class="mt-2" />
            </div>

            <!-- Old Image (hidden) -->
            <input type="hidden" name="oldImage" value="{{ $social->image }}">
            ...
            <div class="mb-4">
                ...
                <div class="avatar my-4 block">
                    <div class="w-16 rounded-xl ring-gray-500 ring-offset-base-100 ring ring-offset-2">
                        <img class="image-preview bg-gray-200" src="{{ asset('storage/' . $social->image) }}" />
                    </div>
                </div>
